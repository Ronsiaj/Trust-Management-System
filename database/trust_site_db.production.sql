...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2026 at 05:11 PM
...
ALTER TABLE `payments`
  ...
  ADD KEY `idx_payments_donor` (`donor_id`);
...
--
ALTER TABLE `payments`
  ADD CONSTRAINT `payments_ibfk_1` FOREIGN KEY (`donation_id`) REFERENCES `donations` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `payments_ibfk_2` FOREIGN KEY (`donor_id`) REFERENCES `users` (`id`);
